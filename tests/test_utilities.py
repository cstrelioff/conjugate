...
class UtilitiesTest(unittest.TestCase):
    ...
    def test_hdcr_binomial_01(self):
        """
        * utils: test_hdcr_binomial_01 -- test HDCR for binomial inference 01
        ...
        self.assertListEqual(hdcr, pre_comp)

    def test_hdcr_binomial_02(self):
        """
    ...
    def test_ccr_binomial_01(self):
        ...
        * utils: test_ccr_binomial_01 -- test CCR for binomial inference 01
        ...
        self.assertListEqual(ccr, pre_comp)

    def test_ccr_binomial_02(self):
        """
